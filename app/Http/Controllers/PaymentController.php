...
class PaymentController extends Controller
{
    ...
    public function createProductSlot($slots,$totalAmount,$orderId,$grandTotal,$gstAmount,$discountAmount)
    {
        // dd($grandTotal);
        $order = ProductOrder::query()->where("order_id", $orderId)->first();
    ...
    public function initiateTransaction(Request $request)
    {
        ...
        $this->createProductSlot($slots,$totalAmount,$orderId,$grandTotal,$gstAmount,$discountAmount);
