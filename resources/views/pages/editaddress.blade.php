                    ...
                    @if ($add = App\Models\user_addres::where('user_id', Auth::user()->user_id)->where('id', '!=', Auth::user()->user_default_address_id)->get())
                        @foreach ($add as $ad)
                            <div class="orders2">
                                ...
                                <div class="text-end">
                                    <a href="/deletaddress/{{ $ad->id }}" class="fcdin delete-address1" data-address-id="{{ $ad->id }}">Delete Address</a>
                                </div>
                                ...
                                <p class="def_del">Delivery at <strong>
                                    ...
                                    <div class="rergff">
                                        <a href="/makedefault/{{ $ad->id }}" type="submit" class="make_as" id="make_default1">Make as Default</a>
                                    </div>
