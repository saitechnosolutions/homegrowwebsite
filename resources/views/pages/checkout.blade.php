                        ...
                        @if ($user)
                            <div class="row  ruyt">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control c_addres"
                                            value="{{ $userData?->address_line_one ?? '' }}" name="address_line_one">
                                    </div>
                                    <span id="msg4" class="text-danger"></span>
                                </div>
                                <div class="col-lg-6 mt-4">
                                    ...
                                    <span id="msg5" class="text-danger"></span>
                                </div>

                                <div class="col-lg-6 mt-4">
                                    <div class="form-group">
                                        <label for="" class="">State</label>
                                        <input type="text" value="{{ $userData?->state ?? '' }}"
                                            class="form-control c_state" class="" id="pin_state" name="pin_state"
                                            readonly>
                                    </div>
                                    <span id="msg6" class="text-danger"></span>
                                </div>
                                ...
                                <div class="col-lg-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $userData?->city ?? '' }}"
                                            class="form-control c_city" class="" id="pin_district"
                                            name="pin_district" readonly>
                                    </div>
                                    <span id="msg7" class="text-danger"></span>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="city_input" class="form-select areas c_landmark" id="city_input">
                                            ...
                                            <option value="{{ $userData?->area_name ?? '' }}"
                                                @if ($userData?->area_name == $area?->area_name) selected @endif>
                                                {{ $userData?->area_name ?? '' }}
                                            </option>
                    ...
                    <div class="col-lg-4 ">
                        <div class="row sticky-top   trtt">
                            ...
                            <div class="go_chec ">
                                ...
                                <button type="button" class="btn  home-btn4 checkoutform">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
