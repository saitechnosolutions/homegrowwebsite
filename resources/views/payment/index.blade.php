		...
		<!--<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b></b></font></caption></table>-->
			<table align="center">
				...
				<tr>
					...
					<td><input type="hidden" name="redirect_url" value="https://homegrow.co.in/api/payment_response"/></td>
					<input type="hidden" name="cancel_url" value="https://homegrow.co.in/api/payment_response"/>
		        ...
		        <!--	 <input type="text" name="billing_email" value="" readonly />-->
